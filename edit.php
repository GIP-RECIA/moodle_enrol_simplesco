...
/**
 * Adds new instance of enrol_simplesco to specified course
...
require_capability('enrol/simplesco:config', $context);

$PAGE->set_url('/enrol/simplesco/edit.php', array('courseid'=>$course->id));
...
$plugin = enrol_get_plugin('simplesco');

if ($instances = $DB->get_records('enrol', array('courseid'=>$course->id, 'enrol'=>'simplesco'), 'id ASC')) {
...
$mform = new enrol_simplesco_edit_form(null, array($instance, $plugin, $context));
...
$PAGE->set_title(get_string('pluginname', 'enrol_simplesco'));
$PAGE->set_heading($course->fullname);

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('pluginname', 'enrol_simplesco'));
$mform->display();
echo $OUTPUT->footer();
