...
/**
 * Enrol simplesco external PHPunit tests
 *
...
require_once($CFG->dirroot . '/enrol/simplesco/externallib.php');

class enrol_simplesco_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_enrol_users() {
        ...
        $roleid = $this->assignUserCapability('enrol/simplesco:enrol', $context1->id);
        ...
        $this->assignUserCapability('enrol/simplesco:enrol', $context2->id, $roleid);
        ...
        enrol_simplesco_external::enrol_users(array(
        ...
        $this->unassignUserCapability('enrol/simplesco:enrol', $context1->id, $roleid);
        try {
            enrol_simplesco_external::enrol_users(array(
                array('roleid' => 3, 'userid' => $user1->id, 'courseid' => $course1->id),
            ));
        ...
        $this->assignUserCapability('enrol/simplesco:enrol', $context1->id, $roleid);
        ...
        // Call for course without simplesco instance.
        $DB->delete_records('user_enrolments');
        ...
        try {
            ...
            $this->fail('Exception expected if course does not have simplesco instance');
        } catch (moodle_exception $e) {
